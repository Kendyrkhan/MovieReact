...
export default function Header() {
  ...
  const handleAdminPanel = () =>{
    ...
    history.push("/adminMain/admin");

  };

  const handleMenuAdminProfile = () => {
    history.push("/adminMain/adminProfile");
    setAnchorEl(null);
    handleMobileMenuClose();
  };
  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={handleMenuAdminProfile}>Admin Profile</MenuItem>
      ...
      <AppBar position="static" style={{backgroundColor:'black'}}>
        <Toolbar className="container">
          ...
          <Typography className={classes.title} variant="h6" noWrap style={{fontSize:"30px"}} >
            <a href="/adminMain/admin"style={{textDecorationLine:'none',color:'white'}}>Admin Panel</a>
          </Typography>
